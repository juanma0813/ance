...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
       ...
       <telerik:RadTabStrip Font-Size="Small" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" Skin="Silk">
            <Tabs>
                <telerik:RadTab  Text="NMX-ANCE" Width="100px" Height="10px" ></telerik:RadTab>
                <telerik:RadTab Text="Quincenal/Cancelación" Width="100px" Height="10px"></telerik:RadTab>
                <telerik:RadTab Text="Caracteristicas" Width="100px" Height="10px" ></telerik:RadTab>
                <telerik:RadTab Text="Aclaraciones" Width="100px" Height="10px" ></telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
            ...
            <telerik:RadPageView runat="server" ID="RadPageView1">
               <table style="width: 100%; height:100px;" class="SinBorde">
                      ...
                      <tr>
                        ...
                        <td></td>
                        <th>
                            <telerik:RadLabel ID="RadLabel14" Text="Bibliografia:" runat="server"></telerik:RadLabel>
                        </th>
                        <td>
