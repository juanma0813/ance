        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
                  ...
                  <tr>
                    ...
                    <td>
                        <telerik:RadDropDownList ID="RadDropDownList1" Width="100px" runat="server"></telerik:RadDropDownList>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="RadTextBox1" Width="100px"  runat="server"></telerik:RadTextBox>
                    </td>
                  </tr>
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel3" Text="Tipo Plan:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                        <asp:RadioButton ID="RadioButton1" Text="Publicado en DOF" runat="server" />
                        <br />
                        <asp:RadioButton ID="RadioButton2" Text="Publicado en DOF" runat="server" />
                    </td>
                  </tr>
                  <tr>
                    <th>
